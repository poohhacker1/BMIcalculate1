...
public class MainActivity extends AppCompatActivity {
    ...
    private void calBMI(){
        ...
        EditText texth = (EditText)findViewById(R.id.editText_hegiht);
        ...
        DecimalFormat decformet = new DecimalFormat("00.00");
        String msg= "ค่า BMI คือ:"+decformet.format(bmi)+"\n";
        msg +="ลักษณธรูปร่างคือ:";

        if (bmi >=40) msg +="อ้วนขั้นสูงสุด";
        else if (bmi >=30)msg += "อ้วนขั้นที่2";
        else if (bmi >=28.5)msg += "อ้วนขั้นที่3";
